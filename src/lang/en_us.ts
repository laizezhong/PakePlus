export default {
    ...
    projectNamePlaceholder: 'Please enter the project name, example: PackPlus',
    releaseBody: 'See the assets to download and install this version.',
    aboutTitle: 'About PackPlus',
    ...
    aboutGuide:
        'PackPlus is open-source and free. It allows you to package web pages or projects like Vue/React into cross-platform apps with just a GitHub Token. It supports standalone executables for Windows, macOS, and Linux, as well as mobile platforms like Android and iOS. If you have any questions, feel free to add me on WeChat: lanxingme (note: PackPlus) or email me at：{email}',
    followme: 'Follow me',
    ...
    initError:
        'Initialization failed, please manually delete your PackPlus repository and try again',
    single: 'Single',
    ...
    sponsor: 'Sponsor',
    sponsorTips:
        'If you also like our PackPlus project, welcome to sponsor us, we will continue to develop and maintain it. Your support is our driving force. Please fill in the message when sponsoring, so that we can record it in the sponsor list, thank you for your support and encouragement!',
    ...
    apiLimitClient: 'This API does not support PackPlus web access',
    ...
    notificationTitle: 'PackPlus Notification API',
