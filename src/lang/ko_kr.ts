export default {
    ...
    projectName: '프로젝트 이름',
    projectNamePlaceholder: '영어 프로젝트 이름을 입력하세요 (예: PackPlus)',
    releaseBody: '이 버전의 리소스를 다운로드 및 설치하려면 참조하세요.',
    aboutTitle: 'PackPlus에 대하여',
    ...
    delSuccess: '삭제 성공',
    aboutGuide:
        'PackPlus는 오픈 소스이며 무료입니다. Github Token 하나만 있으면 웹 페이지를 패키징하여 크로스 플랫폼 앱을 만들 수 있습니다. Windows, macOS, Linux 시스템을 지원하며, 미래에는 Android, iOS 등 모바일 플랫폼도 지원할 것입니다. 문제가 있으시면 저의 WeChat에 추가하세요: lanxingme (참고: PackPlus), 또는 제 이메일을 보내세요: {email}',
    followme: '팔로우 하기',
    moreConfig: '더 많은 설정',
    superpower: '능력',
    scriptFile: '스크립트 파일',
    ...
    initError:
        '초기화 실패, PackPlus 저장소를 수동으로 삭제하고 다시 시도하세요',
    single: '싱글',
    ...
    sponsor: '후원',
    sponsorTips:
        'PackPlus 프로젝트에 관심이 있으시다면, 후원해주세요. 당신의 지지는 우리의 열정을 움직이는 힘입니다. 후원 시 반드시 메시지를 입력하세요. 이는 후원 목록에 기록되며, 당신의 지지와 격려에 감사드립니다!',
    sponsorList: '후원 목록',
    ...
    apiLimitClient: '이 API는 PackPlus 웹 액세스를 지원하지 않습니다',
    ...
    notificationTitle: 'PackPlus 알림 API',
